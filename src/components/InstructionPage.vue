<template>
  <div class="container">
    ...
    <div class="controls">
      <button @click="dismissWindow" class="buttons">DISMISS</button>
    </div>
  </div>
</template>
  ...
  data() {
    return {
      ...
      instructions: [
        ...
        "If you've already started a question, please DO NOT refresh the page or close the browser as you will not be able to return to that question.",
      ],
    };
  },
  methods: {
